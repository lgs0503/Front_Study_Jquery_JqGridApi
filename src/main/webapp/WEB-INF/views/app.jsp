...
<div id="app">
  ...
  <p>
    ...
    <router-link to="/borad">Go to borad</router-link>
...
<script type="text/x-template" id="borad">
	<c:import url="/WEB-INF/views/borad.jsp"></c:import>
</script>
<script type="text/javascript" src="/resources/js/borad.js"></script>
